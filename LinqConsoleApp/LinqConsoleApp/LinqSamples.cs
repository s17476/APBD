    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            res.ToList().ForEach((emp) => Console.WriteLine(emp));
        ...
        public void Przyklad6()
        {
            var res = Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new
            {
                ...
                .Select(mix => new
                {
                    Nazwisko = mix.emp.Ename,
                    Praca = mix.emp.Job,
                    Dział = mix.dept.Dname
                });
        ...
        public void Przyklad10Button_Click()
        {
            ...
            var tmpEmps = new List<Emp>();

            tmpEmps.Add(tmpEmp);

            IEnumerable<Emp> empColTmp = tmpEmps;
        ...
        public void Przyklad11()
        {
            ...
            {
                if (res.Salary >= next.Salary) return res;
                else return next;
            });
